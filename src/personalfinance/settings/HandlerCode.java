...
public final class HandlerCode {
    ...
    public static final String MENU_VIEW_STATISTIC = "MENU_VIEW_STATISTIC";
    ...
    public static final String TOOLBAR_STATISTIC = "TOOLBAR_STATISTIC";
    public static final String TOOLBAR_ADD = "TOOLBAR_ADD";
    public static final String TOOLBAR_EDIT = "TOOLBAR_EDIT";
    public static final String TOOLBAR_DELETE = "TOOLBAR_DELETE";
